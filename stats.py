...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.addexp = QtWidgets.QLineEdit(self.centralwidget)
        self.addexp.setObjectName("addexp")
        self.horizontalLayout_3.addWidget(self.addexp)

        # Expense addition button
        self.appendexp = QtWidgets.QPushButton(self.centralwidget)
        self.appendexp.setObjectName("appendexp")
        ...
        # Chk pwd Button
        self.chkpwd = QtWidgets.QPushButton(self.centralwidget)
        self.chkpwd.setObjectName("chkpwd")
        ...
        # is Day
        self.isday = QtWidgets.QCheckBox(self.centralwidget)
        self.isday.setObjectName("isday")
        self.horizontalLayout_2.addWidget(self.isday)
        # Is month
        self.ismonth = QtWidgets.QCheckBox(self.centralwidget)
        self.ismonth.setObjectName("ismonth")
        self.horizontalLayout_2.addWidget(self.ismonth)
        # Is year
        self.isyear = QtWidgets.QCheckBox(self.centralwidget)
        self.isyear.setObjectName("isyear")
        ...
        # Expenses label
        self.extraexpenses = QtWidgets.QLabel(self.centralwidget)
        self.extraexpenses.setObjectName("extraexpenses")
